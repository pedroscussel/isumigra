...
class MaterialAccessTest extends TestFeature
{
    public function testMaterialAccess()
    {
        ...
        $data = ['admin@tecnova.ind.br',   ['index'=> 200, 'create' => 200, 'view' => 200, 'edit' => 403]]; //migra
        $this->accessWithUser($data, $viewName, $item, "--");
        $data = ['admin@tecnova.ind.br',   ['index'=> 200, 'create' => 200, 'view' => 200, 'edit' => 403]]; //cliente
        $this->accessWithUser($data, $viewName, $item, "--");

        $data = ['ope@tecnova.ind.br',     ['index'=> 200, 'create' => 200, 'view' => 200, 'edit' => 403]]; //migra
        $this->accessWithUser($data, $viewName, $item, "--");
        $data = ['ope@tecnova.ind.br',     ['index'=> 200, 'create' => 200, 'view' => 200, 'edit' => 403]]; //cliente
        $this->accessWithUser($data, $viewName, $item, "--");

        $data = ['dir@tecnova.ind.br',     ['index'=> 200, 'create' => 403, 'view' => 200, 'edit' => 403]]; //migra
        $this->accessWithUser($data, $viewName, $item, "--");
        $data = ['dir@tecnova.ind.br',     ['index'=> 200, 'create' => 403, 'view' => 200, 'edit' => 403]]; //cliente
        $this->accessWithUser($data, $viewName, $item, "--");

        $data = ['com@tecnova.ind.br',     ['index'=> 200, 'create' => 403, 'view' => 200, 'edit' => 403]]; //migra
        $this->accessWithUser($data, $viewName, $item, "--");
