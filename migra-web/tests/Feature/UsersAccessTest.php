...
class UserAccessTest extends TestFeature
{
    public function testUserAccess()
    {
        ...
        $data = ['ope@migra.ind.br',       ['index'=> 200, 'create' => 403, 'view' => 200, 'edit' => 200]]; //migra
        $this->accessWithUser($data, $viewName, $item, "migra");
        $data = ['ope@migra.ind.br',       ['index'=> 200, 'create' => 403, 'view' => 200, 'edit' => 200]]; //cliente
        $this->accessWithUser($data, $viewName, $item, "cliente");
        ...
        $data = ['ope@tecnova.ind.br',     ['index'=> 200, 'create' => 403, 'view' => 403, 'edit' => 403]]; //migra
        $this->accessWithUser($data, $viewName, $item, "migra");
        $data = ['ope@tecnova.ind.br',     ['index'=> 200, 'create' => 403, 'view' => 200, 'edit' => 200]]; //cliente
        $this->accessWithUser($data, $viewName, $item, "cliente");
