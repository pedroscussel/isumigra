...
class CompanyAccessTest extends TestFeature
{
    public function testCompanyAccess()
    {
        ...
        //-----------
        //index: pode acessar localhost/VIEWNAME e ver qualquer coisa (não testa se migra ou cliente)
        //create: pode acessar localhost/VIEWNAME/create e criar algo (não testa se migra ou cliente)
        //view: pode acessar localhost/VIEWNAME/$id/view e visualizar dados (testa se migra ou cliente)
        //edit: pode acessar localhost/VIEWNAME/$id/edit e visualizar dados (testa se migra ou cliente)
